...
# channel
my_channel = Config.YOUR_CHANNEL or "Y_RUS_NETWORK"
my_group = Config.YOUR_GROUP or "Y_RUS_SUPPORT"
if "@" in my_channel:
...
# My Channel
chnl_link = "https://t.me/Y_RUS_NETWORK"
Legend_channel = f"[Lêɠêɳ̃dẞø† ]({chnl_link})"
grp_link = "https://t.me/Y_RUS_SUPPORT"
